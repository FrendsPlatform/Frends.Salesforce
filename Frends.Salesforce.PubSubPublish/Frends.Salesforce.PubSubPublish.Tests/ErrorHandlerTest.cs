...
public class ErrorHandlerTest
{
    ...
    {
        AsyncTestDelegate action = () => Salesforce.PubSubPublish(DefaultInput(), DefaultConnection(), DefaultOptions(), CancellationToken.None);
    ...
    public void Should_Use_Custom_ErrorMessageOnFailure()
    {
        ...
        AsyncTestDelegate action = () => Salesforce.PubSubPublish(DefaultInput(), DefaultConnection(), options, CancellationToken.None);
        var ex = Assert.ThrowsAsync<Exception>(action);
        Assert.That(ex, Is.Not.Null);
